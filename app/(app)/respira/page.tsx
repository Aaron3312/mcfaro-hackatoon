"use client";
// Módulo de bienestar — respiración guiada y recordatorios
import { TemporizadorRespiracion } from "@/components/respira/TemporizadorRespiracion";

const recordatorios = [
  { emoji: "💧", titulo: "Toma agua",          descripcion: "Intenta tomar al menos 8 vasos al día, aunque estés ocupado." },
  { emoji: "🚶", titulo: "Camina un poco",      descripcion: "5 minutos caminando por el pasillo ayudan a despejar la mente." },
  { emoji: "🍎", titulo: "Come algo nutritivo", descripcion: "Tu energía es la energía de tu familia. Aliméntate bien." },
  { emoji: "🤝", titulo: "Pide ayuda",          descripcion: "No tienes que estar solo. El equipo de Casa Ronald está aquí." },
];
