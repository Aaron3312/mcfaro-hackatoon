    ...
    <main className="relative w-full h-screen overflow-hidden bg-[#03060f] flex items-center justify-center select-none">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 sm:px-12 max-w-5xl w-full">
        ...
        <div ref={dividerRef} style={{ opacity: 0 }}
          className="flex items-center gap-3 mb-10 sm:mb-14 origin-center">
        ...
        {/* Bloques en fila */}
        <div className="flex flex-col sm:flex-row items-stretch justify-center gap-4 sm:gap-6 w-full">

          {/* Bloque 1 — PWA */}
          <div
            ref={block1Ref}
            className="flex-1 max-w-sm flex flex-col items-center sm:items-start text-center sm:text-left
                       rounded-2xl p-6 sm:p-8 gap-4"
            style={{
              background: 'rgba(255,255,255,0.03)',
              border: '1px solid rgba(248,208,80,0.10)',
          ...
          >
            ...
            <div className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0"
              style={{ background: 'rgba(248,208,80,0.08)', border: '1px solid rgba(248,208,80,0.15)' }}>
              {/* Señal WiFi off — SVG inline */}
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#F8D060" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div>
              <p className="text-white/90 font-bold mb-1"
                style={{ fontSize: 'clamp(1.1rem, 2.8vw, 1.6rem)' }}>
                PWA
              </p>
              <p className="text-amber-200/60 font-medium mb-3"
              ...
              <p className="text-white/30 font-light leading-relaxed"
                ...
                Citas, rutina y menú disponibles aunque no haya señal en el hospital.
              </p>
            </div>
          </div>
          ...
          <div className="hidden sm:block w-px self-stretch"
            style={{ background: 'linear-gradient(to bottom, transparent, rgba(248,208,80,0.15), transparent)' }}
          />
          ...
          >
            ...
            <div>
              ...
              <p className="text-white/30 font-light leading-relaxed"
                style={{ fontSize: 'clamp(0.78rem, 1.6vw, 0.95rem)' }}>
                Diseñada para usarse con un pulgar, parado en un pasillo, con la mente ocupada.
              </p>
            </div>
          </div>
