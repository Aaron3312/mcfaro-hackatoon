"use client";
// Galería circular WebGL basada en react-bits (ogl)
// Renderiza imágenes en un carrusel curvo con scroll infinito
...
class Media {
  ...
  createTitle() {
    // Si no hay texto, no crear el label debajo de la imagen
    if (!this.text) return;
